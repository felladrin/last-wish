...
namespace Server.Misc
{
    public class CharacterCreation
	{
		...
		private static void EventSink_CharacterCreated( CharacterCreatedEventArgs args )
		{
			...
			newChar.Skills[SkillName.Alchemy].Cap = 120;
			newChar.Skills[SkillName.Anatomy].Cap = 120;
			newChar.Skills[SkillName.AnimalLore].Cap = 120;
			newChar.Skills[SkillName.ItemID].Cap = 120;
			newChar.Skills[SkillName.ArmsLore].Cap = 120;
			newChar.Skills[SkillName.Parry].Cap = 120;
			newChar.Skills[SkillName.Begging].Cap = 120;
			newChar.Skills[SkillName.Blacksmith].Cap = 120;
			newChar.Skills[SkillName.Fletching].Cap = 120;
			newChar.Skills[SkillName.Peacemaking].Cap = 120;
            newChar.Skills[SkillName.Camping].Cap = 120;
            newChar.Skills[SkillName.Carpentry].Cap = 120;
            newChar.Skills[SkillName.Cartography].Cap = 120;
            newChar.Skills[SkillName.Cooking].Cap = 120;
            newChar.Skills[SkillName.DetectHidden].Cap = 120;
            newChar.Skills[SkillName.Discordance].Cap = 120;
            newChar.Skills[SkillName.EvalInt].Cap = 120;
            newChar.Skills[SkillName.Healing].Cap = 120;
            newChar.Skills[SkillName.Fishing].Cap = 120;
            newChar.Skills[SkillName.Forensics].Cap = 120;
            newChar.Skills[SkillName.Herding].Cap = 120;
            newChar.Skills[SkillName.Hiding].Cap = 120;
            newChar.Skills[SkillName.Provocation].Cap = 120;
            newChar.Skills[SkillName.Inscribe].Cap = 120;
            newChar.Skills[SkillName.Lockpicking].Cap = 120;
            newChar.Skills[SkillName.Magery].Cap = 120;
            newChar.Skills[SkillName.MagicResist].Cap = 120;
            newChar.Skills[SkillName.Tactics].Cap = 120;
            newChar.Skills[SkillName.Snooping].Cap = 120;
            newChar.Skills[SkillName.Musicianship].Cap = 120;
            newChar.Skills[SkillName.Poisoning].Cap = 120;
            newChar.Skills[SkillName.Archery].Cap = 120;
            newChar.Skills[SkillName.SpiritSpeak].Cap = 120;
            newChar.Skills[SkillName.Stealing].Cap = 120;
            newChar.Skills[SkillName.Tailoring].Cap = 120;
            newChar.Skills[SkillName.AnimalTaming].Cap = 120;
            newChar.Skills[SkillName.TasteID].Cap = 120;
            newChar.Skills[SkillName.Tinkering].Cap = 120;
            newChar.Skills[SkillName.Tracking].Cap = 120;
            newChar.Skills[SkillName.Veterinary].Cap = 120;
            newChar.Skills[SkillName.Swords].Cap = 120;
            newChar.Skills[SkillName.Macing].Cap = 120;
            newChar.Skills[SkillName.Fencing].Cap = 120;
            newChar.Skills[SkillName.Wrestling].Cap = 120;
            newChar.Skills[SkillName.Lumberjacking].Cap = 120;
            newChar.Skills[SkillName.Mining].Cap = 120;
            newChar.Skills[SkillName.Meditation].Cap = 120;
            newChar.Skills[SkillName.Stealth].Cap = 120;
            newChar.Skills[SkillName.RemoveTrap].Cap = 120;
            newChar.Skills[SkillName.Necromancy].Cap = 120;
            newChar.Skills[SkillName.Focus].Cap = 120;
            newChar.Skills[SkillName.Chivalry].Cap = 120;
            newChar.Skills[SkillName.Bushido].Cap = 120;
            newChar.Skills[SkillName.Ninjitsu].Cap = 120;
            newChar.Skills[SkillName.Spellweaving].Cap = 120;
            newChar.Skills[SkillName.Mysticism].Cap = 120;
            newChar.Skills[SkillName.Imbuing].Cap = 120;
            newChar.Skills[SkillName.Throwing].Cap = 120;
