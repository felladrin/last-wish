...
namespace Server.Mobiles
{
    public class Paragon
    {
        ...
        public static bool CheckConvert(BaseCreature bc, Point3D location, Map m)
        {
            ...
            // Removed to allow paragons spawn in every map.
        ...
        public static void GiveArtifactTo(Mobile m)
        {
            ...
            if (m.AddToBackpack(item)) m.SendMessage("As a reward for slaying the mighty paragon, an artifact has been placed in your backpack.");
            else m.SendMessage("As your backpack is full, your reward for destroying the legendary paragon has been placed at your feet.");
        }
    }
}