		...
		*/
		...
		public virtual bool Teach( SkillName skill, Mobile m, int maxPointsToLearn, bool doTeach )
		{
			...
			switch ( res )
			{
				...
				{
                    m.SendMessage("Make sure this skill is marked to raise. If you are near the skill cap ({0} points) you may need to lose some points in another skill first.", m.SkillsCap / 10);
					break;
				}
