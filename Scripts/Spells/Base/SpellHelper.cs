...
/* Recall From */	{ true,		true,		true,		true,		true,		true,			true,			true,		true,				true,				true,				true,		true,		true,			true,						false,			false,				false,		false },
/* Recall To */		{ true,		true,		true,		true,		true,		true,			true,			true,		true,				true,				true,				false,		false,		false,			false,						false,			false,				false,		false },
/* Gate From */		{ true,		true,		true,		true,		true,		true,			true,			true,		true,				true,				true,				false,		true,		true,			true,						false,			false,				false,		false },
/* Gate To */		{ true,		true,		true,		true,		true,		true,			true,			true,		true,				true,				true,				false,		false,		false,			false,						false,			false,				false,		false },
/* Mark In */		{ true,		true,		true,		true,		true,		true,			true,			true,		true,				true,				true,				false,		false,		false,			false,						false,			false,				false,		false },
/* Tele From */		{ true,		true,		true,		true,		true,		true,			true,			true,		true,				true,				true,				false,		false,		true,			true,						true,			true,				false,		true },
/* Tele To */		{ true,		true,		true,		true,		true,		true,			true,			true,		true,				true,				true,				false,		false, 		true,			true,						true,			true,				false,		false },
			};
