        ...
        public static void PlaceNPC(string[] fakespawnsA, string[] fakespawnsB, string[] fakespawnsC, string[] fakespawnsD, string[] fakespawnsE, string sx, string sy, string sz, string sm, string smintime, string smaxtime, string swalkingrange, string shomerange, string sspawnid, string snpccount, string sfakecountA, string sfakecountB, string sfakecountC, string sfakecountD, string sfakecountE, params string[] types)
        {
            ...
            switch (map)
            {
                case 0://Trammel and Felucca
                    MakeSpawner(types, fakespawnsA, fakespawnsB, fakespawnsC, fakespawnsD, fakespawnsE, x, y, z, Map.Felucca, mintime, maxtime, walkingrange, homerange, npccount, fakecountA, fakecountB, fakecountC, fakecountD, fakecountE);
                    MakeSpawner(types, fakespawnsA, fakespawnsB, fakespawnsC, fakespawnsD, fakespawnsE, x, y, z, Map.Trammel, mintime, maxtime, walkingrange, homerange, npccount, fakecountA, fakecountB, fakecountC, fakecountD, fakecountE);
                    break;
                case 1://Felucca
                    MakeSpawner(types, fakespawnsA, fakespawnsB, fakespawnsC, fakespawnsD, fakespawnsE, x, y, z, Map.Felucca, mintime, maxtime, walkingrange, homerange, npccount, fakecountA, fakecountB, fakecountC, fakecountD, fakecountE);
                    break;
                case 2://Trammel
                    ...
                    break;
                case 3://Ilshenar
                    MakeSpawner(types, fakespawnsA, fakespawnsB, fakespawnsC, fakespawnsD, fakespawnsE, x, y, z, Map.Ilshenar, mintime, maxtime, walkingrange, homerange, npccount, fakecountA, fakecountB, fakecountC, fakecountD, fakecountE);
                    break;
                case 4://Malas
                    MakeSpawner(types, fakespawnsA, fakespawnsB, fakespawnsC, fakespawnsD, fakespawnsE, x, y, z, Map.Malas, mintime, maxtime, walkingrange, homerange, npccount, fakecountA, fakecountB, fakecountC, fakecountD, fakecountE);
                    break;
                case 5://Tokuno
                    MakeSpawner(types, fakespawnsA, fakespawnsB, fakespawnsC, fakespawnsD, fakespawnsE, x, y, z, Map.Maps[4], mintime, maxtime, walkingrange, homerange, npccount, fakecountA, fakecountB, fakecountC, fakecountD, fakecountE);
                    break;
                case 6://TerMur
                    MakeSpawner(types, fakespawnsA, fakespawnsB, fakespawnsC, fakespawnsD, fakespawnsE, x, y, z, Map.Maps[5], mintime, maxtime, walkingrange, homerange, npccount, fakecountA, fakecountB, fakecountC, fakecountD, fakecountE);
                    break;
