...
namespace Server.Gumps
{
    public class SpawnCurrentGump : Gump
    {
        ...
        {
        	CommandSystem.Register("SpawnMaps", AccessLevel.Administrator, new CommandEventHandler(SpawnCurrent_OnCommand));
        }

        [Usage("SpawnMaps")]
        [Description("Generate Spawners around the world with a gump.")]
