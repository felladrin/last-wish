...
namespace Server.Items
{
	...
	public abstract class BoardGameControlItem : Item
	{
		...
		/*****************************************/
		/*****************************************/
		public bool _AllowSpeedUpgrade = true;
		[CommandProperty( AccessLevel.GameMaster )]
		public bool AllowSpeedUpgrade
		{
			get{ return _AllowSpeedUpgrade; }
			set
			{
				_AllowSpeedUpgrade = value;
			}
		}
		
		public bool _AllowDetonatorUpgrade = true;
		[CommandProperty( AccessLevel.GameMaster )]
		public bool AllowDetonatorUpgrade
		{
			get{ return _AllowDetonatorUpgrade; }
			set
			{
				_AllowDetonatorUpgrade = value;
			}
		}
		
		public bool _AllowBaddaBoomUpgrade = true;
		[CommandProperty( AccessLevel.GameMaster )]
		public bool AllowBaddaBoomUpgrade
		{
			get{ return _AllowBaddaBoomUpgrade; }
			set
			{
				_AllowBaddaBoomUpgrade = value;
			}
		}
		
		public bool _AllowBlastStrengthUpgrade = true;
		[CommandProperty( AccessLevel.GameMaster )]
		public bool AllowBlastStrengthUpgrade
		{
			get{ return _AllowBlastStrengthUpgrade; }
			set
			{
				_AllowBlastStrengthUpgrade = value;
			}
		}
		/******************************************/
		/******************************************/
