...
namespace Server.Mobiles
{
	...
	public class EnslavedGreenGoblin : BaseCreature
	{
		...
		public EnslavedGreenGoblin() : base( AIType.AI_Melee, FightMode.Closest, 10, 1, 0.2, 0.4 )
		{
			...
			SetResistance( ResistanceType.Fire, 38 );
			SetResistance( ResistanceType.Cold, 26 );
			SetResistance( ResistanceType.Poison, 12 );
			SetResistance( ResistanceType.Energy, 18 );

			SetSkill( SkillName.MagicResist, 120.2 );
			SetSkill( SkillName.Tactics, 89.5 );
			SetSkill( SkillName.Anatomy, 81.4 );
			SetSkill( SkillName.Wrestling, 106.8 );
