...
AddonComponent( 2928 );
			...
			ac.Name = "Um Candelabro";
			AddComponent( ac, 0, 1, 17 );

			ac = new AddonComponent( 4006 );
			ac.Name = "Teclas do Piano";
		...
		public override void OnComponentUsed( AddonComponent ac, Mobile from )
		{
			if ( !from.InRange( GetWorldLocation(), 1 ) )
				from.SendMessage( "Você está muito longe para usá-lo!" );
...
namespace Server.Gumps
{
    public class PianoGump : Gump
    {
		public PianoGump() :base( 0, 0 )
        {
			...
			AddLabel( 19, 20, 200, "Teclas do Piano");
			AddLabel(55, 60, 0, @"do");
			AddLabel(55, 80, 0, @"do");
			...
			AddLabel(545, 60, 0, @"si");
			AddLabel(545, 80, 0, @"si");
        ...
        public override void OnResponse( NetState sender, RelayInfo info )
		{
			...
			{
				case 0: { m.SendMessage( 60, "Você pára de tocar."); break; }
				...
				case 26: { m.SendMessage( 60, "Você pára de tocar." ); break; }
