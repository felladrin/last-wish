...
namespace Server.Gumps
{
    public class ScoutGump : Gump
    {
        ...
        public ScoutGump(Mobile owner, string filter)
            : this(owner, BuildList(owner, filter), 0)
        {
        }

        public ScoutGump(Mobile owner, List<Mobile> list, int page)
        ...
        public override void OnResponse(NetState state, RelayInfo info)
        {
            ...
            switch (info.ButtonID)
            {
                ...
                case 1: // Previous
                    {
                        if (m_Page > 0)
                            from.SendGump(new ScoutGump(from, m_Mobiles, m_Page - 1));
                ...
                default:
                    {
                        ...
                        if (index >= 0 && index < m_Mobiles.Count)
                        {
                            ...
                            if (m.Deleted)
                            {
                                ...
                                from.SendGump(new ScoutGump(from, m_Mobiles, m_Page));
                            }
