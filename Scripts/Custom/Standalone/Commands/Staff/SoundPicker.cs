...
{
    public class SoundPickerGump : Gump
    {
        ...
        static void Sounds_OnCommand(CommandEventArgs e)
        {
            Mobile from = e.Mobile;
            from.CloseGump(typeof(SoundPickerGump));
            from.SendGump(new SoundPickerGump(0));
        }

        public TextRelay SoundID;
        public int SoundVal;
				
        public SoundPickerGump(int SoundVal)
            : base(0, 0)
        {
            Closable = true;
            Disposable = true;
