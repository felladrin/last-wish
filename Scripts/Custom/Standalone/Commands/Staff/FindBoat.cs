...
namespace Server.Gumps
{
    public class FindboatGump : Gump
    {
        ...
        [Usage("FindBoat")]
        [Description("List all boats of the world")]
        ...
        public FindboatGump(Mobile from, ArrayList list, int page)
            : base(50, 40)
        {
            ...
            AddLabelCropped(32, 16, 100, 20, 1152, "Nome do Barco");
            AddLabelCropped(132, 16, 120, 20, 1152, "Dono");
            AddLabelCropped(292, 16, 120, 20, 1152, "Local");
            AddLabel(80, 290, 93, String.Format("Haazen's Boat Locator             {0} Barcos estão no mar", boats));
