...
namespace Server.Gumps
{
    public class MyHousesGump : Gump
    {
        ...
        [Usage("MyHouses")]
        [Description("Displays a menu listing all your houses. The menu also contains specific house details, and options to: go to house, and demolish house.")]
        ...
        public MyHousesGump(Mobile from, List<BaseHouse> list, BaseHouse sel)
            : base(50, 40)
        {
            m_From = from;
            m_List = list;
